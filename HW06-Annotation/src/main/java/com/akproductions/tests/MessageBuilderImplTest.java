package com.akproductions.tests;
...
import com.akproductions.testframework.annotations.DisplayName;
import com.akproductions.testframework.annotations.Test;

public class MessageBuilderImplTest implements MessageBuilder {
    ...
    public MessageBuilderImplTest() {
        templateProvider=new MessageTemplateProvider();
        getMessageTemplateCalled=0;
    }

    public MessageBuilderImplTest(MessageTemplateProvider templateProvider) {
